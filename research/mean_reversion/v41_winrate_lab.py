...
results_df.to_csv(
    "results/mean_reversion/v41_factor_walkforward.csv",
    index=False
)
...
summary_df.to_csv(
    "results/mean_reversion/v41_factor_summary.csv",
    index=False
)
...
print("=" * 70)
print("results/mean_reversion/v41_factor_walkforward.csv")
print("results/mean_reversion/v41_factor_summary.csv")
print("=" * 70)