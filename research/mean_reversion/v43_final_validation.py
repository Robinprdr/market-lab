...
FILE = "results/mean_reversion/backtest_v4_score5_trades.csv"
...
results.to_csv(
    "results/mean_reversion/v43_global_results.csv",
    index=False
)

summary.to_csv(
    "results/mean_reversion/v43_walk_forward_results.csv",
    index=False
)

print("\nFichiers créés :")
print("  results/mean_reversion/v43_global_results.csv")
print("  results/mean_reversion/v43_walk_forward_results.csv")
